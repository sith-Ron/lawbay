...
export const Contact = ({ children }: { children: React.ReactNode }) => {
    return (
        <Popover>
            ...
            <PopoverContent className="m-2 bg-white rounded-md shadow-lg p-4 w-[200px] md:w-auto">
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-600">
                        <a href="tel:+255 768 977 777" className=" ">
                            Phone: <span className="hover:underline text-orange-500">+255 768 977 777</span>
                        </a>
                    </p>
                    <p className="text-sm text-gray-600">
