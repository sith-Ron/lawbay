...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        id="navbar"
        className={`fixed w-full z-50 flex items-center justify-between p-4 ${
          isScrolled ? "bg-orange-200 rounded-br-lg rounded-bl-lg shadow-lg text-black" : "bg-transparent"
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <a href="#" className="text-xl font-bold {isScrolled ? 'text-black' : 'text-white'}">
            LAWBAY ADVOCATES
          </a>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-4">
          {menuItems.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="hover:text-white {isScrolled ? 'text-black' : 'text-white'}"
            >
              {item.name}
            </a>
          ))}
      ...
      <div className="pt-20">
        <div className="relative">
          ...
          />
          <div className="relative flex flex-col items-center justify-center min-h-screen text-white py-8 px-4">
